...
public final class ContextModule$$ModuleAdapter extends ModuleAdapter<ContextModule> {
  ...
  public ContextModule$$ModuleAdapter() {
    super(au.com.cybersearch2.classyapp.ContextModule.class, INJECTS, STATIC_INJECTIONS, false /*overrides*/, INCLUDES, true /*complete*/, false /*library*/);
  }
   ...
   */
  @Override
  public void getBindings(BindingsGroup bindings, ContextModule module) {
  ...
  public static final class ProvideContextProvidesAdapter extends ProvidesBinding<android.content.Context>
    ...
    public ProvideContextProvidesAdapter(ContextModule module) {
      super("android.content.Context", IS_SINGLETON, "au.com.cybersearch2.classyapp.ContextModule", "provideContext");
      this.module = module;
      setLibrary(false);
    }
